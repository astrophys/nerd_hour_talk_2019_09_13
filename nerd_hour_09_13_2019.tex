...
\begin{picture}(320,250) 
    ...
    \put(-30, 40){\includegraphics[height=1.35in]{images/m87.eps}}
    \put(-75, 150){\includegraphics[height=1.35in]{images/m87_event_horizon.eps}}
    \put(0, 140){\begin{minipage}[t]{0.7 \linewidth}
        {\small M87}
    \end{minipage}}
    \put(120, 220){\begin{minipage}[t]{0.7 \linewidth}
...
\begin{picture}(320,250) 
    ...
    \put(-30, 40){\includegraphics[height=1.35in]{images/cygx1_xray.eps}}
    % https://www.eso.org/public/images/eso1907a/
    \put(-25, 150){\includegraphics[height=1.35in]{images/cygx1_synth.eps}}
    \put(0, 140){\begin{minipage}[t]{0.7 \linewidth}
        {\small Cygnus X-1}
    \end{minipage}}
    \put(120, 220){\begin{minipage}[t]{0.7 \linewidth}
...
% Show video of MW central black hole. M87
\begin{picture}(320,250) 
    \put(-30, 40){\includegraphics[height=1.10in]{images/ligo_livingston.eps}}
    %https://journals.aps.org/prl/abstract/10.1103/PhysRevLett.116.061102
    \put(-25, 150){\includegraphics[height=1.10in]{images/ligo_setup.eps}}
    \put(120, 220){\begin{minipage}[t]{0.7 \linewidth}
...
% Show video of MW central black hole. M87
\begin{picture}(320,250) 
    \put(50, 50){\includegraphics[height=2.40in]{images/ligo_first_detection.eps}}
    %https://journals.aps.org/prl/abstract/10.1103/PhysRevLett.116.061102
...
% Show video of MW central black hole. M87
\begin{picture}(320,250) 
    \put(50, 50){\includegraphics[height=2.40in]{images/ligo_first_detection_2.eps}}
    %https://journals.aps.org/prl/abstract/10.1103/PhysRevLett.116.061102
    \put(70, 240){\begin{minipage}[t]{0.7 \linewidth}
    A black hole merger - $36M_{\odot} + 29M_{\odot}$  
    \end{minipage}}
